package lk.ijse.dep10.reports.controller;
...
public class MainViewController {
    ...
    @FXML
    private Button btnPrintReports;
    @FXML
    ...
    public void btnExportReportsOnAction(ActionEvent actionEvent) throws JRException {
        ...
        File file = fileChooser.showSaveDialog(btnExportReports.getScene().getWindow());
        if(file==null) return;
    ...
    public void btnPrintReportsOnAction(ActionEvent actionEvent) throws JRException {
